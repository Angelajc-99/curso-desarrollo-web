...
// let contadorMins = 0;
// // Botón START
// // El crónometro arranca
// function start() {

//     // Aumento el contador a uno por que la función se ejecuta cada centésima de segundo
//     contadorCents = contadorCents +1;

//     // Compruebo si las centesimas llega a cien y si es así reiniciar el contador y aumentar un segundo
//     if (contadorCents == 100) {
//         // reiniciamos el contador
//         contadorCents = 0;
//         // los segundos aumentan en 1
